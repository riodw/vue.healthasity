                                                    ...
                                                    <div class="row"><!-- left -->
                                                        <div class="col-sm"><!-- top -->
                                                            ...
                                                            class="h4 m-0 text-white">
                                                                {{ row.type }}<i class="material-icons">chevron_right</i>
                                                            </router-link>
                                                        </div>
                                                        <div class="col-sm"><!-- bottom -->
                                                            <small class="text-light">
                                                                {{ row.time }} &mdash; 3:00 pm
                                                            </small>
                                                ...
                                                <div>
                                                    ...
                                                    v-if="index === row.active_page">
                                                        ...
                                                        <div v-if="page.chart">
                                                            ...
                                                            :options="setChartOptions(row.health_type, page.chart)"
                                                            :series="page.chart.series"></apexchart>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
